...
namespace GameServer.EventSystem.Events {
	...
	public sealed class OnceCheckOverAspectCreatedEvent : Event {
		public struct EventInfo : IEventInfo {
			public bool swallowed;

			public IJSAPI<Aspect> createdAspect;
			public IJSAPI<Character> from;
			public IJSAPI<Character> to;
			public CharacterAction action;
	...
	public sealed class OnceCheckOverCauseDamageEvent : Event {
		public struct EventInfo : IEventInfo {
			public bool swallowed;
