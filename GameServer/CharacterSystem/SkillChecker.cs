...
namespace GameServer.CharacterSystem {
	public sealed class SkillChecker {
		...
		static SkillChecker() {
			...
			_OVERCOME.Add(SkillType.Burglary, new List<SkillType>(new SkillType[] { }));
			...
			_OVERCOME.Add(SkillType.Crafts, new List<SkillType>(new SkillType[] { }));
			...
			_OVERCOME.Add(SkillType.Notice, new List<SkillType>(new SkillType[] { SkillType.Burglary, SkillType.Stealth }));
			_OVERCOME.Add(SkillType.Physique, new List<SkillType>(new SkillType[] { SkillType.Physique, SkillType.Fight, SkillType.Shoot, SkillType.Crafts }));
			...
			_OVERCOME.Add(SkillType.Shoot, new List<SkillType>(new SkillType[] { SkillType.Athletics, SkillType.Drive }));
			...
			_EVADE.Add(SkillType.Burglary, new List<SkillType>(new SkillType[] { }));
			_EVADE.Add(SkillType.Contacts, new List<SkillType>(new SkillType[] { SkillType.Contacts, SkillType.Deceive }));
			_EVADE.Add(SkillType.Crafts, new List<SkillType>(new SkillType[] { }));
			...
			_EVADE.Add(SkillType.Notice, new List<SkillType>(new SkillType[] { SkillType.Burglary, SkillType.Stealth }));
			_EVADE.Add(SkillType.Physique, new List<SkillType>(new SkillType[] { SkillType.Physique, SkillType.Fight, SkillType.Shoot, SkillType.Crafts }));
			...
			_EVADE.Add(SkillType.Shoot, new List<SkillType>(new SkillType[] { SkillType.Athletics, SkillType.Drive }));
